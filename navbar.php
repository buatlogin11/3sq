...
<body>
  <nav class="navbar fixed-top navbar-dark bg-dark rounded-lg px-3">
    <a class="navbar-brand" href="index.php">
      <img src="assets/aku pnj.png" width="50" height="50" alt="">
    </a>
    ...
    <div class="navbar-collapse collapse " id="navbarsExample01">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item mt-3">
          <a class="text-light text-decoration-underline-on-hover link-offset-2 link-underline link-underline-opacity-0" href="profile.php">Profil</a>
        </li>
        <li class="nav-item mt-3">
          <a class="text-light text-decoration-underline-on-hover link-offset-2 link-underline link-underline-opacity-0" href="tiket.php">Tiket</a>
        </li>
        <li class="nav-item mt-3">
